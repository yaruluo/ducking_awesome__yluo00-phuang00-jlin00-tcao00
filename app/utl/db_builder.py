...
def build_db():
    ...
    command = "CREATE TABLE IF NOT EXISTS user_tbl (user_id INTEGER PRIMARY KEY AUTOINCREMENT, username TEXT, password TEXT, mood TEXT, sleep TEXT, period TEXT, permissions INT, friends TEXT, requests TEXT)"
    exec(command)
